...
(custom-theme-set-faces
 ...
 '(fringe ((((background light)) :inherit default :foreground "grey70")
 ...
 '(mode-line ((t :inherit variable-pitch :background "LightSteelBlue2" :foreground "black"
                 :box (:line-width 4 :style flat-button :color "LightSteelBlue2")
                 :height 1.0)))
 '(mode-line-inactive ((t :inherit mode-line :background "LightSteelBlue2" :foreground "grey50")))
