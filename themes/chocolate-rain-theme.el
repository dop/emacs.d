...
(deftheme chocolate-rain "Chocolate Rain")
...
(let ((choco-fg "#c3be98")
      ...
      (choco-blue-0 "#8a9a95")
      (choco-blue-1 "#5f9ea0")
      (choco-brown-0 "#b3935c")
      (choco-brown-1 "#9b703f")
      (choco-brown-2 "#a18764")
      (choco-brown-3 "#6d4c2f")
      (choco-brown-4 "#211612")
      (choco-gray-0 "#696969")
      (choco-gray-1 "#a7a7a7")
      (choco-gray-2 "#483b39")
      (choco-gray-3 "#1c1c1c")
      (choco-green-0 "#7ca563")
      (choco-green-1 "#679d47")
      (choco-green-2 "#999d63")
      (choco-purple-0 "#a8799c")
      (choco-red-0 "#cf6a4c")
      (choco-red-1 "#da5659")
      (choco-yellow-0 "#f1e694")
      (choco-yellow-1 "#e5e894")
      (choco-yellow-2 "#c8be0f"))

  (custom-theme-set-faces
   'chocolate-rain
   `(default ((t (:foreground ,choco-fg :background ,choco-bg))))
   `(cursor ((t (:foreground ,choco-black :background "red"))))
   `(vertical-border ((t (:foreground ,choco-brown-3))))
   `(mode-line ((t (:foreground ,choco-black :background ,choco-brown-0 :box (:line-width 2 :color ,choco-brown-0)))))
   `(mode-line-highlight ((t (:foreground ,choco-yellow-2))))
   `(mode-line-inactive ((t (:foreground ,choco-fg :background ,choco-brown-4 :box (:line-width 2 :color ,choco-brown-4)))))
