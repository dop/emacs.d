(custom-set-variables
 ...
 '(display-buffer-alist
   '(("\\*.*eshell\\*"
      ...
      (side . bottom)
      (slot . -1))
     ("\\*\\([Hh]elp\\|Backtrace\\|Warnings\\|Messages\\|info\\)\\*"
      (display-buffer-reuse-window display-buffer-in-previous-window display-buffer-in-side-window)
      (window-width . 0.375)
      (side . right)
      (slot . 1))
 ...
 '(package-selected-packages
   '(flymake-proselint jsonrpc flymake eldoc project json-mode editorconfig sly prettier paredit-menu exec-path-from-shell markdown-mode nodejs-repl string-edit typescript-mode wgrep xterm-color flymake-eslint olivetti ns-auto-titlebar cider quick-peek eglot lsp paredit-everywhere slime-company whitespace-cleanup-mode use-package undo-tree restclient protobuf-mode paredit neotree hungry-delete git-timemachine dictionary csv-mode company))
 '(paredit-lighter " ParEd")
 ...
 '(safe-local-variable-values '((eval yoshi-project-mode t) (yoshi-project-mode . t)))
 ...
 '(version-control t)
 '(visible-bell nil)
 '(undo-tree-mode-lighter " ᛘ")
 '(window-sides-slots '(0 0 2 2)))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:background "white" :foreground "black" :weight semi-light :height 120 :width normal :family "Noto Sans Mono"))))
